...
},{"./bootstrap":2,"./mainctrl":3,"angular-route/angular-route":4,"angular/angular":5}],2:[function(require,module,exports){
require('angular/angular');
...
/**
 * @license AngularJS v1.2.9-build.2121+sha.c7a46d4
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.9-build.2121+sha.c7a46d4/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.9-build.2121+sha.c7a46d4',    // all of these placeholder strings will be replaced by grunt's
